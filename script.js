...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const updateStudioIdentity = () => {
        const { name, fullName } = appState.studioProfile;
        ...
        // 3. Update Text Spans (Footers)
        document.querySelectorAll('.studio-name-text').forEach(el => {
            el.innerText = name;
        });

        // --- NEW: Generate Dynamic Manifest ---
        const dynamicManifest = {
            "name": fullName || name, // Use full name if available, else short name
            "short_name": name,       // The name used under the app icon
            "icons": [
                {
        ...
        // Set the href to our dynamic URL
