        ...
        container.onclick = (e) => {
            ...
            if (removeTarget) {
                    ...
                    database.ref().update(updates)
                        .then(() => {
                            database.ref(`/users/${memberId}`).once('value', snapshot => {
                                ...
                                // UPDATED CALL: Pass the 'editLabel' argument through recursively
                ...
                if (historyEntry) {
                    ...
                    // Removed the temporary toast message to avoid clutter
                    onEditStart();
                }
            }
        };
                    ...
                    database.ref().update(updates)
                        .then(() => {
                            database.ref(`/users/${memberId}`).once('value', snapshot => {
                                ...
                                // UPDATED CALL: Pass 'editLabel' argument through recursively
