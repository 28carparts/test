...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const updateStudioIdentity = () => {
        // 1. Destructure with defaults (fall back to white if DB is empty)
        ...
        // 5. Update Browser Address Bar Color (Meta Tag)
        // This changes the color of the URL bar in Chrome on Android immediately
        ...
        const dynamicManifest = {
            ...
            "icons": [
                {
                    "src": "android-chrome-192x192-black.png",
                    "sizes": "192x192",
                    "type": "image/png"
                },
                {
                    "src": "android-chrome-512x512-black.png",
                    "sizes": "512x512",
                    "type": "image/png"
                }
            ],
            // Use the variables from Firebase
